        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                @include('components.card-stats', [
                    'title' => 'Permohonan',
                    'value' => $countPermohonanStatusDataBerkasKurang,
                    'icon' => 'fas fa-users',
                ])
            </div>
            <div class="col-sm-6 col-md-3">
                @include('components.card-stats', [
                    'title' => 'Permohonan',
                    'value' => $countPermohonanStatusDiproses,
                    'icon' => 'fas fa-users',
                ])
            </div>
            <div class="col-sm-6 col-md-3">
                @include('components.card-stats', [
                    'title' => 'Permohonan',
                    'value' => $countPermohonanStatusDiterima,
                    'icon' => 'fas fa-users',
                ])
            </div>
            <div class="col-sm-6 col-md-3">
                @include('components.card-stats', [
                    'title' => 'Permohonan',
                    'value' => $countPermohonanStatusDitolak,
                    'icon' => 'fas fa-users',
                ])
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-primary btn-round ms-auto" href="{{ route('permohonan.create') }}">
